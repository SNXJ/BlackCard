...
import com.zsh.blackcard.music.receiver.NoisyAudioStreamReceiver;
import com.zsh.blackcard.music.untils.Actions;
import com.zsh.blackcard.music.untils.AppCache;
import com.zsh.blackcard.music.untils.MusicUtils;
...
//        unregisterReceiver(mNoisyReceiver);
    ...
    private Runnable mPublishRunnable = new Runnable() {
        @Override
        public void run() {
            if (isPlaying() && mListener != null && null != mPlayer) {
                //TODO
