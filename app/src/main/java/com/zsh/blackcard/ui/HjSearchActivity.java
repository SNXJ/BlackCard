...
public class HjSearchActivity extends BaseActivity implements TextView.OnEditorActionListener {
    ...
    private void initData() {
        DataManager.getInstance(this).RequestHttp(NetApi.postHomeSearchHot(DataManager.getMd5Str("SERRCHLIST"), "3"), new ResultListener<HomeSearchHotModel>() {
            @Override
            public void responseSuccess(HomeSearchHotModel obj) {
                if (obj.getResult().equals("01")) {
                    ...
                    for (int i = 0; i < listHot.size(); i++) {
                        int ranHeight = dip2px(HjSearchActivity.this, 24);
                        ViewGroup.MarginLayoutParams lp = new ViewGroup.MarginLayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ranHeight);
                        lp.setMargins(dip2px(HjSearchActivity.this, 10), 0, dip2px(HjSearchActivity.this, 10), 0);
                        TextView tv = new TextView(HjSearchActivity.this);
                        tv.setPadding(dip2px(HjSearchActivity.this, 10), 0, dip2px(HjSearchActivity.this, 10), 0);
                    ...
                    zg_search_recommend_recycler.setLayoutManager(new GridLayoutManager(HjSearchActivity.this, 2));
                    zg_search_recommend_recycler.setAdapter(zgSearchRecommendAdapter);
                    zg_search_et.setOnEditorActionListener(HjSearchActivity.this);
                }
            }
