...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_PATH = "/data/data/com.zsh.blackcard/databases/";
    /*
     * //如果你想把数据库文件存放在SD卡的话 private static String DB_PATH =
     * android.os.Environment.getExternalStorageDirectory().getAbsolutePath() +
     * "/arthurcn/drivertest/packfiles/";
     */
    private static final String DB_NAME = "zsh_cities";
    private static final String ASSETS_NAME = "zsh_cities.db";
    ...
    public void createDataBase() throws IOException {
        ...
        if (dbExist) {
            LogUtils.i("DBHelper", "城市选择数据库已经存在");
            // 数据库已存在，do nothing.
        } else {
            // 创建数据库
            try {
