...
import com.zsh.blackcard.model.GiftModel;
...
public class GiftItemView extends LinearLayout {
    ...
    public void refreshView(){
        ...
        if (!TextUtils.isEmpty(gift.img)){
            Glide.with(getContext()).load(gift.img).into(avatar);
        }else {
            avatar.setImageResource(R.mipmap.room_image_1);
        }
    ...
    public interface OnAnimatorListener{
        public void onAnimationEnd(GiftModel gift);
        public void onAnimationStart(Animator animation);
    }
}
