 ...
 * Name: LiveBeatView
 * Author: Shing
 * Date: 2018/2/2 上午10:18
 * Description: ..
 */

public class LiveBeatView extends View {
...
//    private RectF r5;
    ...
    public LiveBeatView(Context context) {
        this(context, null);
    }

    public LiveBeatView(Context context, AttributeSet attrs) {
        this(context, attrs, -1);
    }

    public LiveBeatView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mPaint.setColor(Color.WHITE);
        mPaint.setColor(getContext().getResources().getColor(R.color.ff92_text));
