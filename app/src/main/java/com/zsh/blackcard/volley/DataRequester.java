...
public class DataRequester {
    ...
    private DataRequester(Type type) {
        if (type == Type.HTTP) {
     ...
     * @return
     */
    public static DataRequester withHttp() {
        return new DataRequester(Type.HTTP);
    }
     ...
     * @return
     */
    public static DataRequester withDefaultHttps() {
        return new DataRequester(Type.HTTPS_DEFALT);
    }
     ...
     * @return
     */
    public static DataRequester withSelfCertifiedHttps() {
        return new DataRequester(Type.HTTPS_SELF_CERTIFIED);
    }
            ...
            request = new StringRequest(
                ...
                public byte[] getBody() throws AuthFailureError {
                    ...
                    try {
                        ...
                        LogUtils.i(TAG,"Encoding not supported: utf-8 ");
...
//            LogUtils.d(TAG, request.getBody().toString());
            try {
                LogUtils.d(TAG, new String(request.getBody(), "utf-8"));
