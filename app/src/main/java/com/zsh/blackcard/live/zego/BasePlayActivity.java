...
import com.zsh.blackcard.live.BaseLiveActivity;
...
public abstract class BasePlayActivity extends BaseLiveActivity {
    ...
    protected void initExtraData(Bundle savedInstanceState) {
        if (savedInstanceState == null) {
            ...
            mRoomID = intent.getStringExtra(Constants.ROOM_ID);
            mOldSavedStreamList = intent.getStringArrayListExtra(Constants.LIST_STREAM);
        }
    ...
    static protected ArrayList<String> getStremListFromRoomInfo(LiveInfoListModel.DataBean.RoomListBean roomInfo) {
        ...
        if (roomInfo.stream_info != null && roomInfo.stream_info.size() > 0) {
            ...
            for (LiveInfoListModel.DataBean.StreamInfo stream : roomInfo.stream_info) {
