...
public class SingleAnchorActivity extends BasePublishActivity {
    ...
    public static void actionStart(Activity activity, String publishTitle, boolean enableFrontCam, boolean enableTorch, int selectedBeauty, int selectedFilter, int appOrientation) {
        Intent intent = new Intent(activity, SingleAnchorActivity.class);
        intent.putExtra(Constants.PUBLISH_TITLE, publishTitle);
        intent.putExtra(Constants.ENABLE_FRONT_CAM, enableFrontCam);
        intent.putExtra(Constants.ENABLE_TORCH, enableTorch);
        intent.putExtra(Constants.SELECTED_BEAUTY, selectedBeauty);
        intent.putExtra(Constants.SELECTED_FILTER, selectedFilter);
        intent.putExtra(Constants.APP_ORIENTATION, appOrientation);
