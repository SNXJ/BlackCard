...
import com.zsh.blackcard.live.zego.Constants;
import com.zsh.blackcard.live.zego.PreferenceUtil;
import com.zsh.blackcard.live.zego.ViewLive;
import com.zsh.blackcard.live.zego.ZegoApiManager;
import com.zsh.blackcard.live.zego.ZegoRoomUtil;
...
public abstract class BasePublishActivity extends BaseLiveActivity {
    ...
    protected void initExtraData(Bundle savedInstanceState) {
        if (savedInstanceState == null) {
            ...
            mPublishTitle = intent.getStringExtra(Constants.PUBLISH_TITLE);
            mEnableFrontCam = intent.getBooleanExtra(Constants.ENABLE_FRONT_CAM, false);
            mEnableTorch = intent.getBooleanExtra(Constants.ENABLE_TORCH, false);
            mSelectedBeauty = intent.getIntExtra(Constants.SELECTED_BEAUTY, 0);
            mSelectedFilter = intent.getIntExtra(Constants.SELECTED_FILTER, 0);
            mAppOrientation = intent.getIntExtra(Constants.APP_ORIENTATION, Surface.ROTATION_0);
        }
