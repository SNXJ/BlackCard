 ...
 * 双列滚轮选择
 */
public class SelsectTwoDialog extends Dialog implements View.OnClickListener {
    ...
    public SelsectTwoDialog(Context context, String defaultJsonAsset, String defaultData) {
    ...
    private void initDatas() {
        try {
            JSONArray jsonArray = mJsonObj.getJSONArray("dataList");
