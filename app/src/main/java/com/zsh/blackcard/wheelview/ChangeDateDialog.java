...
public class ChangeDateDialog extends Dialog implements View.OnClickListener {
    ...
    private OnDateListener onDateListenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_select_date_wheel);
    ...
    public void setOnDateListener(OnDateListener onDateListenter) {
        this.onDateListenter = onDateListenter;
    }
    ...
    public void onClick(View v) {
        ...
        if (v == btnSure) {
            if (onDateListenter != null) {
                onDateListenter.onClick(selectYear, selectMonth, selectDay);
            }
        } else if (v == btnSure) {
