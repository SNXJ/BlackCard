 ...
 * Description:描述：
 */
public class MusicSingerSongAdapter extends BaseQuickAdapter<MusicSingerModel.PdBean.ArtistBean, BaseViewHolder> {

    public MusicSingerSongAdapter(List<MusicSingerModel.PdBean.ArtistBean> data) {
