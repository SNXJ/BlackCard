...
public class RegisterCardDiamondAdapter extends RecyclerView.Adapter<RegisterCardDiamondAdapter.MyViewHolder> {

    private Context context;
    private List<Boolean> isCheck = new ArrayList<>();
    private List<RegisterChangeNumberModel.PdBean> pd;

    private RegisterDiamondOnItemClick registerDiamondOnItemClick;

    public void setRegisterDiamondOnItemClick(RegisterDiamondOnItemClick registerDiamondOnItemClick) {
        this.registerDiamondOnItemClick = registerDiamondOnItemClick;
    }

    public interface RegisterDiamondOnItemClick {
        void diamondOnItemClick(int position);
    }

    public RegisterCardDiamondAdapter(RegisterActivity registerActivity, List<RegisterChangeNumberModel.PdBean> pd) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //设置监听回调
                if (registerDiamondOnItemClick != null) {
                    registerDiamondOnItemClick.diamondOnItemClick(position);
                }
