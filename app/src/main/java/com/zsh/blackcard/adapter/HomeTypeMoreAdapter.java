...
public class HomeTypeMoreAdapter extends BaseQuickAdapter<HomePrivilegeModel.PdBean,BaseViewHolder> {

    public HomeTypeMoreAdapter(int layoutResId, @Nullable List<HomePrivilegeModel.PdBean> data) {
