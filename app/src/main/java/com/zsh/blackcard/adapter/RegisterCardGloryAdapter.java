...
public class RegisterCardGloryAdapter extends RecyclerView.Adapter<RegisterCardGloryAdapter.MyViewHolder> {
    ...
    public RegisterCardGloryAdapter(RegisterActivity registerActivity, List<RegisterChangeNumberModel.PdBean> pd) {
