 ...
 * Description:描述：
 */
public class TicketSearchAdapter2 extends BaseQuickAdapter<TicketSearchModel, BaseViewHolder> {


    private int type;

    public TicketSearchAdapter2(List<TicketSearchModel> data, int type) {
