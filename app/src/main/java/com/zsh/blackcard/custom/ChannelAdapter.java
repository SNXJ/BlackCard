...
import com.zsh.blackcard.view.draghelper.OnDragVHListener;
import com.zsh.blackcard.view.draghelper.OnItemMoveListener;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    private void moveMyToOther(MyViewHolder myHolder) {
        ...
        ChannelModel item = mMyChannelItems.get(startPosition);
    ...
    private int processItemRemoveAdd(OtherViewHolder otherHolder) {
        ...
        ChannelModel item = mOtherChannelItems.get(startPosition);
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        ChannelModel item = mMyChannelItems.get(fromPosition - COUNT_PRE_MY_HEADER);
