...
import com.zsh.blackcard.adapter.LiveMusicAdapter;

public class LiveMusicDialog extends DialogFragment implements View.OnClickListener {
    ...
    private LiveMusicAdapter mMusicAdapter;
    ...
    private LiveMusicAdapter.MusicInfo mMusicInfo = null;

    public static LiveMusicDialog newInstance() {
        LiveMusicDialog pushBeautyDialog = new LiveMusicDialog();
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setStyle(DialogFragment.STYLE_NO_FRAME, R.style.pub_loading_dialog);
    }
...
//        getDialog().getWindow().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
        View view = inflater.inflate(R.layout.live_music_dialog_layout, container);
        ...
        if (mMusicAdapter == null) {
            mMusicAdapter = new LiveMusicAdapter(getActivity());
        ...
        try {
            switch (id) {
                ...
                case R.id.loop:
                    ...
                    isLoop = !loopSelected;
                    if (mMusicAdapter != null) {
                        mMusicAdapter.updateItemView((LiveMusicAdapter.MusicViewHolder) mMusicRecyclerView.findViewHolderForAdapterPosition(mPosition), mPosition, !loopSelected);
                    }
                    break;
                case R.id.mute:
    ...
    public interface OnItemClick {
        void onItemClick(LiveMusicAdapter.MusicInfo musicInfo, int position);
    }

    private OnItemClick mOnItemClick = new OnItemClick() {
        @Override
        public void onItemClick(LiveMusicAdapter.MusicInfo musicInfo, int position) {
...
//        mMute.setEnabled(bool);
    ...
    public void updateProgress(long progress, long totalTime) {
        if (mMusicAdapter != null) {
            mMusicAdapter.updateProgress((LiveMusicAdapter.MusicViewHolder) mMusicRecyclerView.findViewHolderForAdapterPosition(mPosition), progress, totalTime);
        }
    }
